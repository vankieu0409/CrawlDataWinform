...
namespace CrawlDataWinform
{
    public partial class MainUI : Form
    {
        ...
        { var list=new List<ProductVariant>();
            if (File.Exists(@"D:\DATN\Crawl_Data\Ram.json"))
            {
                using (StreamReader r = new StreamReader(@"D:\DATN\Crawl_Data\Ram.json"))
                {
            ...
            using (StreamWriter file = File.CreateText(@"D:\DATN\Crawl_Data\Ram.json"))
            {
